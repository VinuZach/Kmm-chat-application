...
data class ChatState(val messages:List<MessageDto> = emptyList(),val isLoading:Boolean=true,val groupDetailsList:GroupDetailsResponseDto = GroupDetailsResponseDto())
