...
@Serializable
data class MessageDto(var message: String, var user: String, var new_page_number: Int, var blocked_user: List<String>?,var prevMessages:List<PrevMessage>?,var chat_room_user_list:String) {
    @Serializable
